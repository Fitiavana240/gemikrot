 ...
 *
 * **Copie exacte de `apps/backend/src/public/identifiant.ts`.** Les deux
 * doivent donner le même résultat : la page annonce un identifiant, le
 * serveur le réserve, et deux règles divergentes feraient afficher un nom et
 * en créer un autre. Le partage par paquet viendra avec le découpage du
 * bundle public ; en attendant, toute correction se fait des deux côtés.
 */
